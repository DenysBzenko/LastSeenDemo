...
{
    public class UserMinMaxCalculatorTests
    {
        private readonly OnlineDetector _onlineDetector;
        private readonly UserMinMaxCalculator _minMaxCalculator;

        public UserMinMaxCalculatorTests()
        {
            _onlineDetector = new OnlineDetector(new MockDateTimeProvider());
            _minMaxCalculator = new UserMinMaxCalculator(_onlineDetector);
        }
        ...
        public void CalculateMinMax_WhenUserWasOnline()
        {
            ...
            // Act
            var minMax = _minMaxCalculator.CalculateMinMax(userTimeSpans,
